...
class DraftsControllerTest < ActionController::TestCase
  ...
  test "should create draft" do
    assert_difference('Draft.count') do
      post :create, draft: { content: @draft.content, ithupload: @draft.ithupload, timeofthedraft: @draft.timeofthedraft }
    end
  ...
  test "should update draft" do
    put :update, id: @draft, draft: { content: @draft.content, ithupload: @draft.ithupload, timeofthedraft: @draft.timeofthedraft }
    assert_redirected_to draft_path(assigns(:draft))
  end
